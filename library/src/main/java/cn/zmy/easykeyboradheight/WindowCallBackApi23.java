...
public class WindowCallBackApi23 implements Window.Callback
{
    private Window.Callback preCallBack;
    private KeyboardHeightProvider provider;

    public WindowCallBackApi23(Window.Callback preCallBack, KeyboardHeightProvider provider)
    {
    ...
    {
        return preCallBack.onSearchRequested(searchEvent);
    }
    ...
    {
        return preCallBack.onWindowStartingActionMode(callback, type);
    }
